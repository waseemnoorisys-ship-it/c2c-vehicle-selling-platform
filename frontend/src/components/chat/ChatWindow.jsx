      ...
      <div className="h-16 bg-[#202c33] px-3 sm:px-4 flex items-center justify-between border-b border-gray-800 shrink-0 z-10">
        ...
        <div className="flex items-center gap-3">
          {activeConv.listingId && (
            <button
              onClick={() => navigate(`/vehicles/${activeConv.listingId._id || activeConv.listingId}`)}
            ...
            >
              ...
              <span className="max-w-[150px] truncate">
                {activeConv.listingId.title || "View Listing"}
              </span>
            </button>
          )}
            ...
            {showDropdown && (
              ...
              >
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-xs text-red-400 hover:bg-gray-700 font-medium"
                >
                  Block User
                </button>
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-xs text-yellow-400 hover:bg-gray-700 font-medium"
                >
                  Report Conversation
                </button>
              </div>
