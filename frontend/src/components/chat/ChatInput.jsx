...
export default function ChatInput({ conversationId, replyingTo, onCancelReply, isClosed }) {
  if (isClosed) {
    return (
      <div className="bg-[#202c33] border-t border-gray-800 px-4 py-3.5 text-center text-gray-400 text-xs flex items-center justify-center gap-2 shrink-0">
        <svg className="w-4 h-4 text-amber-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
        </svg>
        <span>Conversation is closed because this vehicle has been sold. Message history is saved as a record.</span>
      </div>
    );
  }
