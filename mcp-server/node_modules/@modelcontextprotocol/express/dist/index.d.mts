...
import { AuthInfo, AuthMetadataOptions, AuthMetadataOptions as AuthMetadataOptions$1, BearerAuthOptions, OAuthTokenVerifier, getOAuthProtectedResourceMetadataUrl } from "@modelcontextprotocol/server";
...
//#endregion
//#region src/auth/bearerAuth.d.ts
/**
 * Options for {@link requireBearerAuth}.
 */
type BearerAuthMiddlewareOptions = BearerAuthOptions;
/**
 ...
 */
declare function requireBearerAuth(options: BearerAuthMiddlewareOptions): RequestHandler;
//#endregion
//#region src/auth/metadataRouter.d.ts
/**
 ...
 */
declare function mcpAuthMetadataRouter(options: AuthMetadataOptions$1): Router;
//#endregion
...
//#endregion
export { type AuthMetadataOptions, type BearerAuthMiddlewareOptions, CreateMcpExpressAppOptions, type OAuthTokenVerifier, createMcpExpressApp, getOAuthProtectedResourceMetadataUrl, hostHeaderValidation, localhostHostValidation, localhostOriginValidation, mcpAuthMetadataRouter, originValidation, requireBearerAuth };
