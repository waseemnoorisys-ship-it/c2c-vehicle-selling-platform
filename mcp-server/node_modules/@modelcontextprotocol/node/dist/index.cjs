...
var NodeStreamableHTTPServerTransport = class {
	...
	constructor(options = {}) {
		this._webStandardTransport = new _modelcontextprotocol_server.WebStandardStreamableHTTPServerTransport(options);
		this._requestListener = (0, _hono_node_server.getRequestListener)(async (webRequest) => {
	...
	*/
	async handleRequest(req, res, parsedBody) {
		...
		await (0, _hono_node_server.getRequestListener)(async (webRequest) => {
			return this._webStandardTransport.handleRequest(webRequest, {
				authInfo,
				parsedBody
			});
...
//#endregion
exports.NodeStreamableHTTPServerTransport = NodeStreamableHTTPServerTransport;
